...
?>
        ...
        foreach($data as $row)
        {
            ...
            <?php
              if(isset($_GET["statut"])){
            ?>
            <td class="text-center"><a class="btn btn-info text-center" href="reserver_assoc.php?id_assoc=<?=$row['idAssociation']?>&id_salle=<?=$_GET['id_salle']?>&statut=<?=$_GET['statut']?>">choose</a></td>
            <?php
             }
             else{
            ?>   
              <td class="text-center"><a class="btn btn-info text-center" href="reserver_assoc.php?id_assoc=<?=$row['idAssociation']?>&id_salle=<?=$_GET['id_salle']?>">choose</a></td>
              <?php
             }
            ?> 
